...
plot_figure_8 = function() {
  plot_figure(c(1861, 1156, 13828, 19238), 1850:1960, function(X, Y) { })
}
plot_figure_9 = function() {
  plot_figure(c(13828, 1016, 1156, 19238, 19230), 1950:1964, function(X, Y) { })
}
plot_figure_10 = function() {
  plot_figure(c(18501), 1940:1960, function(X, Y) { })
}
plot_figure_10()
# plot_figure_6(c(18501),function(X,Y){})
# plot_(c(18501), function(X, Y) { })
